...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-lg">SIAKAD |<b> ICMBJ</b></span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <small>Pastikan Logout terlebih dahulu, jika meninggalkan laman ini, demi keamanan akun anda.</small>
                </p>
                <!-- <p>
                  <?php echo $this->session->userdata('nama_lengkap'); ?>
                  <small><b>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#">
            ...
            <span>Manajemen PSB</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="psb"><i class="fa fa-circle-o"></i> Calon Siswa Baru</a></li>
            <li><a href="admin"><i class="fa fa-circle-o"></i> Siswa diterima</a></li>
            <li><a href="admin"><i class="fa fa-circle-o"></i> manajemen...</a></li>
            <li><a href="admin"><i class="fa fa-circle-o"></i> manajemen...</a></li>
          </ul>
        </li>
<!--         <li>
